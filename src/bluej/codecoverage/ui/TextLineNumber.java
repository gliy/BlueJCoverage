 ...
 *  of a JScrollPane.
 *  
 *  This code was found at {@linkplain http://www.camick.com/java/source/TextLineNumber.java}
 */
    ...
    implements CaretListener, DocumentListener, PropertyChangeListener
{
    ...
    protected Color getLineBackground(int rowStartOffset)
    {
        ...
        int index = root.getElementIndex( rowStartOffset );
        Element line = root.getElement( index );
        AttributeSet attributes = line.getAttributes();
        Color color = null;
        if (attributes != null &&  attributes.getAttribute(StyleConstants.Background) != null)
        {
            color = (Color)attributes.getAttribute(StyleConstants.Background);
        }
        return color;
